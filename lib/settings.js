...
// synch
exports.bulk_size_save = 1000;
exports.update_index_interval = 60000;
...
exports.reloadSettings = function reloadSettings() {
  ...
  settingsFilename = path.join(__dirname, "..", settingsFilename);
  ...
  exports.dbsettings.connectionString = `mongodb://${ exports.dbsettings.user }:${ exports.dbsettings.password }@${ exports.dbsettings.address }:${ exports.dbsettings.port }/${ exports.dbsettings.database }`;
};
